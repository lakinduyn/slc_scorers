				...
				<ul class="user-login-option pull-right">
					<li class="social-icon">
						<ul class="social-icons style-5">
							<li><a class="facebook" href="https://www.facebook.com/Sri-Lanka-Cricket-Scorers-222564844449934/"><i class="fa fa-facebook"></i></a></li>
					...
					<li >
						<a href="/login" class="login"><i class="fa fa-user"></i>member Login</a>
							    ...
							    <div class="col-lg-9 col-md-9 col-sm-9">
							    		<div id="mega-blog-slider" class="mega-blog-slider">
											...
											<div class="item">
												...
												<!-- Post Img -->
												<div class="large-post-img">
													<img src="/front_end/images/blog-grid-view/img-2-3.jpg" alt="">
												</div>
												<!-- Post Img -->
