...
<!-- Slider Holder -->
	<div class="slider-holder">
		...
		<ul id="main-slides" class="main-slides">
			    ...
			    <div id="animated-slider" class="carousel slide carousel-fade">
			        ...
			        <div class="carousel-inner" role="listbox">
			            ...
			            <div class="item active">
			            	<img src="/front_end/images/banner-slider/img-01.jpg" alt="">
			            ...
			            <!-- Item -->
			            <div class="item">
			            	<img src="/front_end/images/banner-slider/img-02.jpg" alt="">
				               <div class="position-center-x full-width">
								<div class="container">
			            ...
			            <!-- Item -->
			            <!--<div class="item">
			            	<img src="/front_end/images/banner-slider/img-03.jpg" alt="">
				               <div class="position-center-x full-width">
								<div class="container">
									<div class="banner-caption style-2 p-white h-white pull-left">
										<h1 class="animated fadeInUp delay-1s">Good is not Good <br>When Better is<br> Expected</h1>
			...
			<!-- Itme -->
			<li>
				<img src="/front_end/images/banner-bgs/img-01.jpg" alt="">
			</li>
			<!-- Itme -->

			<!-- Itme -->
			<li>
				<img src="/front_end/images/banner-bgs/img-02.jpg" alt="">
				<div class="position-center-center">
					<div class="container theme-padding">
						<div class="pager-heading match-detail h-white">
							<span class="pull-left win-tag"><img src="/front_end/images/result-team-logo/img-01.png" alt=""></span>
							...
							<span class="pull-right loss-tag"><img src="/front_end/images/result-team-logo/img-02.png" alt=""></span>
						</div>
					</div>
				</div>
			</li>
										...
										<div id="matches-detail-slider" class="matches-detail-slider">
											...
											<div class="item matches-detail" style="background: url(images/country-flags-bg.jpg);">
												...
												<div class="team-btw-match">
													<ul>
														<li>
															<img src="/front_end/images/team-logos/img-01.png" alt="">
															<span>Footbal<span>Team</span></span>
														</li>
														<li>
															<img src="/front_end/images/team-logos/img-02.png" alt="">
										...
										<div class="table-responsive">
											<table class="table table-bordered">
											    <tbody>
												    <tr>
												        <td>
												        	<div class="logo-width-name"><img src="/front_end/images/team-logos-small/img-01.png" alt="">Portugal</div>
												        </td>
												        <td class="upcoming-fixture-date"><span>6 Feb 2016 15:00</span></td>
												        <td>
												        	<div class="logo-width-name w-icon"><img src="/front_end/images/team-logos-small/img-02.png" alt="">Germany</div>
												        </td>
												    </tr>
												    <tr>
												        <td>
												        	<div class="logo-width-name"><img src="/front_end/images/team-logos-small/img-03.png" alt="">Spain</div>
												        </td>
												        <td class="upcoming-fixture-date"><span>6 Feb 2016 15:00</span></td>
												        <td>
												        	<div class="logo-width-name w-icon"><img src="/front_end/images/team-logos-small/img-04.png" alt="">Man Utd</div>
												        </td>
												    </tr>
												    <tr>
												        <td>
												        	<div class="logo-width-name"><img src="/front_end/images/team-logos-small/img-05.png" alt="">Hondrus</div>
												        </td>
												        <td class="upcoming-fixture-date"><span>6 Feb 2016 15:00</span></td>
												        <td>
												        	<div class="logo-width-name w-icon"><img src="/front_end/images/team-logos-small/img-06.png" alt="">Ivory Cost</div>
												        </td>
												    </tr>
												    <tr>
												        <td>
												        	<div class="logo-width-name"><img src="/front_end/images/team-logos-small/img-07.png" alt="">West Brom</div>
												        </td>
												        <td class="upcoming-fixture-date"><span>6 Feb 2016 15:00</span></td>
												        <td>
												        	<div class="logo-width-name w-icon"><img src="/front_end/images/team-logos-small/img-08.png" alt="">uruguay</div>
												        </td>
												    </tr>
											    </tbody>
											</table>
										...
										<div class="row no-gutters white-bg">
											...
											<div class="col-sm-9">
												<ul id="latest-news-slider" class="latest-news-slider">
													<li>
														<img src="/front_end/images/latest-news/img-01.jpg" alt="">
												    ...
												    <li>
														<img src="/front_end/images/latest-news/img-02.jpg" alt="">
													    <p>Chelsea captain John Terry is not ready to start against Stoke on Saturday and is struggling to prove his fitness for next week's crunch...<a href="#">Read more</a></p>
												    </li>
												    <li>
														<img src="/front_end/images/latest-news/img-03.jpg" alt="">
													    <p>Chelsea captain John Terry is not ready to start against Stoke on Saturday and is struggling to prove his fitness for next week's crunch...<a href="#">Read more</a></p>
												    </li>
												    <li>
														<img src="/front_end/images/latest-news/img-04.jpg" alt="">
													    <p>Chelsea captain John Terry is not ready to start against Stoke on Saturday and is struggling to prove his fitness for next week's crunch...<a href="#">Read more</a></p>
												    </li>
												    <li>
														<img src="/front_end/images/latest-news/img-01.jpg" alt="">
									...
									<div class="last-matches theme-margin-bottom win-tag">
										...
										<div class="matches-detail style-2" style="background: url(images/keper-img.jpg);">
											...
											<div class="team-btw-match">
												<ul>
													<li>
														<img src="/front_end/images/team-logos/img-03.png" alt="">
														<span>Munchester<span>United</span></span>
													</li>
													<li>
														<img src="/front_end/images/team-logos/img-04.png" alt="">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="theme-padding top-profiler">
							<img class="player-img animate fadeInLeft" data-wow-delay="0.2s" src="/front_end/images/player-img.png" alt="">
					...
					<div class="col-sm-6">
						<ul id="video-slider" class="video-slider">
							<li class="red-sec-widget player-history h-white p-white">
								...
								<div class="player-video-sec">
									<div class="video video-post">
										<img src="/front_end/images/video-bg.jpg" alt="">
							...
							<li class="red-sec-widget player-history h-white p-white">
								...
								<div class="player-video-sec">
									<div class="video video-post">
										<img src="/front_end/images/video-bg-2.jpg" alt="">
										<span class="play-lable fa fa-video-camera"></span>
										<a class="position-center-center play-icon" href="http://www.youtube.com/watch?v=cH6kxtzovew" data-rel="prettyPhoto[video]"><i class="fa fa-video-camera"></i></a>
									</div>
								</div>
							...
							<li class="red-sec-widget player-history h-white p-white">
								...
								<div class="player-video-sec">
									<div class="video video-post">
										<img src="/front_end/images/video-bg-3.jpg" alt="">
										<span class="play-lable fa fa-video-camera"></span>
										<a class="position-center-center play-icon" href="http://www.youtube.com/watch?v=cH6kxtzovew" data-rel="prettyPhoto[video]"><i class="fa fa-video-camera"></i></a>
									</div>
								</div>
					...
					<div class="gallery">
							...
							<div class="row">
								<div class="col-sm-12 col-xs-12 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-01.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-1.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
								...
								<div class="col-sm-6 col-xs-6 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-02.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-2.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
													<li><a class="fa fa-eye" href="#"></a></li>
												</ul>
											</div>
										</figcaption>
								...
								<div class="col-sm-6 col-xs-6 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-03.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-3.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
													<li><a class="fa fa-eye" href="#"></a></li>
												</ul>
											</div>
										</figcaption>
						...
						<div class="col-sm-6">
							<div class="row">
								<div class="col-sm-6 col-xs-6 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-04.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-4.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
													<li><a class="fa fa-eye" href="#"></a></li>
												</ul>
											</div>
										</figcaption>
								...
								<div class="col-sm-6 col-xs-6 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-05.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-5.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
													<li><a class="fa fa-eye" href="#"></a></li>
												</ul>
											</div>
										</figcaption>
								...
								<div class="col-sm-12 col-xs-12 r-full-width p-0">
									<figure class="gallery-figure">
										<img src="/front_end/images/gallery-v3/img-06.jpg" alt="">
										<figcaption class="overlay">
											<div class="position-center-center">
												<ul class="btn-list">
													<li><a href="/front_end/images/gallery-v3/img-1-6.jpg" data-rel="prettyPhoto[gallery-v3]"><i class="fa fa-search"></i></a></li>
					...
					<div id="team-slider" class="team-slider">
						...
						<div class="item">
							<div class="team-column">
								<img src="/front_end/images/team/img-01.jpg" alt="">
						...
						<div class="item">
							<div class="team-column">
								<img src="/front_end/images/team/img-02.jpg" alt="">
								<span class="player-number">12</span>
								<div class="team-detail">
						...
						<div class="item">
							<div class="team-column">
								<img src="/front_end/images/team/img-03.jpg" alt="">
								<span class="player-number">12</span>
								<div class="team-detail">
						...
						<div class="item">
							<div class="team-column">
								<img src="/front_end/images/team/img-04.jpg" alt="">
								<span class="player-number">12</span>
								<div class="team-detail">
		...
		<div class="products-holder gray-bg theme-padding">
			<div id="product-slider" class="product-slider nav-style-1">
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-01.jpg" alt="">
						</div>
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-02.jpg" alt="">
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-03.jpg" alt="">
						</div>
						<h5><a href="shop-detail.html">Sports T-Shirt</a></h5>
						<span class="product-use">Men’s Running Shirt</span>
					</div>
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-04.jpg" alt="">
						</div>
						<h5><a href="shop-detail.html">Sports T-Shirt</a></h5>
						<span class="product-use">Men’s Running Shirt</span>
					</div>
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-05.jpg" alt="">
							<span class="sale-batch">sale</span>
						</div>
						<h5><a href="shop-detail.html">Sports T-Shirt</a></h5>
						<span class="product-use">Men’s Running Shirt</span>
				...
				<div class="product-column">
					<div class="product-column-inner">
						<div class="product-img">
							<img src="/front_end/images/products/img-06.jpg" alt="">
						</div>
						<h5><a href="shop-detail.html">Sports T-Shirt</a></h5>
						<span class="product-use">Men’s Running Shirt</span>
					</div>
